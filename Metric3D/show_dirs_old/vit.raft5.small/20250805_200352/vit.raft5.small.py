...
distributed = False
load_from = './weight/metric_depth_vit_large_800k.pth'
log_file = './show_dirs/vit.raft5.small/20250805_200352/20250805_200352.log'
max_value = 200
mldb_info = dict(
    NYU=dict(
        data_root='nyu',
...
model = dict(
    backbone=dict(
        checkpoint=
        '/mnt/nas/share/home/xugk/ckpt/vit/dinov2_vits14_reg4_pretrain.pth',
        drop_path_rate=0.0,
        out_channels=[
            384,
            384,
    ...
    decode_head=dict(
        ...
        use_cls_token=True),
    type='DensePredModel')
show_dir = './show_dirs/vit.raft5.small/20250805_200352'
test_metrics = [
    'abs_rel',
    'rmse',
    'silog',
