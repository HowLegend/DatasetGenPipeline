...
log_file = './show_dirs/vit.raft5.large/20250805_200951/20250805_200951.log'
max_value = 200
mldb_info = dict(
    NYU=dict(
        data_root='nyu',
...
model = dict(
    backbone=dict(
        checkpoint=
        '/mnt/nas/share/home/xugk/ckpt/vit/dinov2_vitl14_reg4_pretrain.pth',
        drop_path_rate=0.0,
        out_channels=[
            1024,
            1024,
    ...
    decode_head=dict(
        ...
        use_cls_token=True),
    type='DensePredModel')
show_dir = './show_dirs/vit.raft5.large/20250805_200951'
test_metrics = [
    'abs_rel',
    'rmse',
    'silog',
